...
class NotesListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('DarDerDor Notepad')),
                  ...
                  child: ListTile(
                      ...
                      await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => MultiBlocProvider(
                            providers: [
                              BlocProvider(
                                create: (_) => NoteFormCubit()..setNote(note),
                              ),
                              BlocProvider.value(
                                value: context.read<NotesListBloc>(),
                              ),
                            ],
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (confirm == true) {
                          final result = await notesRepository.deleteNote(
                            note.id ?? -1,
                          );
