...
import 'package:note_app/repositories/notes_repository.dart';
import 'package:note_app/screens/NotesListScreen.dart';
  ...
  Widget build(BuildContext context) {
    return RepositoryProvider(
      ...
      child: MultiBlocProvider(
        ...
        child: MaterialApp(title: 'Notes App', home: const NotesListScreen()),
      ),
    );
  }
}
